...
class GetActiveCallsTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.ringcentral.active_calls.GET';
    }

    public function getDescription(): string
    {
        return 'GET /active-calls - Ruft die aktuell aktiven Anrufe der eigenen Extension ab.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $service->getActiveCalls($context->user);
    ...
    public function getMetadata(): array
    {
        return [
            'category' => 'query',
            'tags' => ['ringcentral', 'telefonie', 'active-calls', 'anrufe'],
            'read_only' => true,
            'requires_auth' => true,
            'risk_level' => 'safe',
        ];

...
class GetAccountInfoTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.ringcentral.account_info.GET';
    }

    public function getDescription(): string
    {
        return 'GET /account/~ - Ruft die Account-Informationen des verbundenen RingCentral-Accounts ab. Gibt Account-ID, Hauptnummer, Status und Service-Plan zurück.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $service->getAccountInfo($context->user);
    ...
    public function getMetadata(): array
    {
        return [
            'category' => 'query',
            'tags' => ['ringcentral', 'telefonie', 'account', 'info'],
            'read_only' => true,
            'requires_auth' => true,
            'risk_level' => 'safe',
        ];

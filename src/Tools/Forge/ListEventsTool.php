...
/**
 * Listet Forge-Events als Audit-Trail — organisationsweit oder je Server.
 */
class ListEventsTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'integrations.forge.events.GET';
    }

    public function getDescription(): string
    {
        return 'GET /orgs/{org}/events — Listet die Events einer Laravel-Forge-Organisation als Audit-Trail '
            . '(wer hat wann was ausgelöst). Mit "server" werden stattdessen nur die Events dieses Servers '
            . 'zurückgegeben. Nützlich, um laufende oder fehlgeschlagene Vorgänge nachzuvollziehen.';
    }
    ...
    public function getSchema(): array
    {
        return [
            ...
            'properties' => [
                'server' => [
                    'type' => 'string',
                    'description' => 'Optional: Server-ID, um nur die Events dieses Servers zu listen.',
                ],
                'organization' => [
                    'type' => 'string',
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = ($server !== null && $server !== '')
                ? $service->listServerEvents($context->user, (string) $server, $organization, $query)
                : $service->listEvents($context->user, $organization, $query);
    ...
    public function getMetadata(): array
    {
        return [
            'category' => 'query',
            'tags' => ['forge', 'laravel', 'events', 'audit', 'list'],
            'read_only' => true,
            'requires_auth' => true,
            'risk_level' => 'safe',
        ];

...
class TestConnectionTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'integrations.datev.test';
    }

    public function getDescription(): string
    {
        return 'Testet die DATEV API-Verbindung (Connectivity-Check). Prüft ob der OAuth2/OIDC-Token gültig ist und die API erreichbar ist.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            if (!$connection) {
                return ToolResult::error('NO_CONNECTION', 'Keine DATEV-Verbindung konfiguriert. Bitte zuerst unter Integrationen mit DATEV verbinden.');
            }
    ...
    public function getMetadata(): array
    {
        return [
            'category' => 'query',
            'tags' => ['datev', 'accounting', 'test', 'connectivity'],
            'read_only' => true,
            'requires_auth' => true,
            'risk_level' => 'safe',
        ];

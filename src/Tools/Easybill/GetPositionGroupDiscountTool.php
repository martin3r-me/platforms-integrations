...
class GetPositionGroupDiscountTool implements ToolContract, ToolMetadataContract
{
    use GuardsArguments;

    public function getName(): string
    {
        return 'integrations.easybill.discount.position-group.GET';
    }

    public function getDescription(): string
    {
        return 'GET /discounts/position-group/{id} — Gruppen-Rabatt abrufen.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->getPositionGroupDiscount($context->user, (int) $arguments['discount_id']);

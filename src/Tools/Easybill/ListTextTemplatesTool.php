...
class ListTextTemplatesTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.easybill.text-templates.GET';
    }

    public function getDescription(): string
    {
        return 'GET /text-templates — Text-Vorlagen listen.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->listTextTemplates($context->user, $arguments['query'] ?? []);

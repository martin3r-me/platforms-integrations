...
class ListTimeTrackingsTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.easybill.time-trackings.GET';
    }

    public function getDescription(): string
    {
        return 'GET /time-trackings — Zeiterfassungen listen.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->listTimeTrackings($context->user, $arguments['query'] ?? []);

...
class CreateSerialNumberTool implements ToolContract, ToolMetadataContract
{
    use GuardsArguments;

    public function getName(): string
    {
        return 'integrations.easybill.serial-number.POST';
    }

    public function getDescription(): string
    {
        return 'POST /serial-numbers — Seriennummer anlegen.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->createSerialNumber($context->user, $arguments['data']);

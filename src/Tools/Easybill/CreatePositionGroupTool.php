...
class CreatePositionGroupTool implements ToolContract, ToolMetadataContract
{
    use GuardsArguments;

    public function getName(): string
    {
        return 'integrations.easybill.position-group.POST';
    }

    public function getDescription(): string
    {
        return 'POST /position-groups — Artikelgruppe anlegen.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->createPositionGroup($context->user, $arguments['data']);

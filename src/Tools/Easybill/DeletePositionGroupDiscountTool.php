...
class DeletePositionGroupDiscountTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.easybill.discount.position-group.DELETE';
    }

    public function getDescription(): string
    {
        return 'DELETE /discounts/position-group/{id} — Gruppen-Rabatt löschen.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->deletePositionGroupDiscount($context->user, (int) $arguments['discount_id']);

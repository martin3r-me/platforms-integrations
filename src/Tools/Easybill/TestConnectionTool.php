...
class TestConnectionTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'integrations.easybill.test';
    }

    public function getDescription(): string
    {
        return 'Testet die easybill API-Verbindung (Connectivity-Check). Prüft ob der Bearer-Token gültig ist und die REST-API erreichbar ist.';
    }
    ...
    public function getSchema(): array
    {
        return [
            'type' => 'object',
            'properties' => [
                'connection_id' => ['type' => 'integer', 'description' => 'ID der easybill-Verbindung.'],
            ],
            'required' => [],
        ];
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            if (!$connection) {
                return ToolResult::error('NO_CONNECTION', 'Keine easybill-Verbindung konfiguriert.');
            }
    ...
    public function getMetadata(): array
    {
        return [
            'category' => 'query',
            'tags' => ['easybill', 'billing', 'test', 'connectivity'],
            'read_only' => true,
            'requires_auth' => true,
            'risk_level' => 'safe',
        ];

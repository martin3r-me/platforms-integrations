...
class DownloadDocumentTool implements ToolContract, ToolMetadataContract
{
    use GuardsArguments;

    public function getName(): string
    {
        return 'integrations.easybill.document.download';
    }

    public function getDescription(): string
    {
        return 'GET /documents/{id}/download — Beleg-Download (ZIP mit PDF + Anhängen, base64).';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->downloadDocument($context->user, (int) $arguments['document_id']);

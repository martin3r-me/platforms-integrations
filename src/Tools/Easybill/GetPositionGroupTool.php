...
class GetPositionGroupTool implements ToolContract, ToolMetadataContract
{
    use GuardsArguments;

    public function getName(): string
    {
        return 'integrations.easybill.position-group.GET';
    }

    public function getDescription(): string
    {
        return 'GET /position-groups/{id} — Artikelgruppe abrufen.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->getPositionGroup($context->user, (int) $arguments['group_id']);

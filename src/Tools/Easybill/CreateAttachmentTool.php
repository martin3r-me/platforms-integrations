...
class CreateAttachmentTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.easybill.attachment.POST';
    }

    public function getDescription(): string
    {
        return 'POST /attachments — Anhang anlegen (data muss base64-Content + Metadaten enthalten).';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->createAttachment($context->user, $arguments['data']);

...
class DeletePostBoxTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.easybill.post-box.DELETE';
    }

    public function getDescription(): string
    {
        return 'DELETE /post-boxes/{id} — Versand-Eintrag löschen.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->deletePostBox($context->user, (int) $arguments['post_box_id']);

...
class GetDocumentJpgTool implements ToolContract, ToolMetadataContract
{
    use GuardsArguments;

    public function getName(): string
    {
        return 'integrations.easybill.document.jpg';
    }

    public function getDescription(): string
    {
        return 'GET /documents/{id}/jpg — Beleg als JPG (base64).';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->getDocumentJpg($context->user, (int) $arguments['document_id']);

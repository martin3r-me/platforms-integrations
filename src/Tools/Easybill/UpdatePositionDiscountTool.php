...
class UpdatePositionDiscountTool implements ToolContract, ToolMetadataContract
{
    use GuardsArguments;

    public function getName(): string
    {
        return 'integrations.easybill.discount.position.PUT';
    }

    public function getDescription(): string
    {
        return 'PUT /discounts/position/{id} — Positions-Rabatt aktualisieren.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->updatePositionDiscount($context->user, (int) $arguments['discount_id'], $arguments['data']);

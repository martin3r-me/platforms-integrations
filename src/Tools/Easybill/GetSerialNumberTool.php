...
class GetSerialNumberTool implements ToolContract, ToolMetadataContract
{
    use GuardsArguments;

    public function getName(): string
    {
        return 'integrations.easybill.serial-number.GET';
    }

    public function getDescription(): string
    {
        return 'GET /serial-numbers/{id} — Seriennummer abrufen.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->getSerialNumber($context->user, (int) $arguments['serial_id']);

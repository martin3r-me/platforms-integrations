...
class DeleteCustomerGroupTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'integrations.easybill.customer-group.DELETE';
    }

    public function getDescription(): string
    {
        return 'DELETE /customer-groups/{id} — Kundengruppe löschen.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->deleteCustomerGroup($context->user, (int) $arguments['group_id']);

...
class CreateStockTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.easybill.stock.POST';
    }

    public function getDescription(): string
    {
        return 'POST /stocks — Lager-Bewegung anlegen.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->createStock($context->user, $arguments['data']);

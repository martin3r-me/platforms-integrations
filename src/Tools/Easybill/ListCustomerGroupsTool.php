...
class ListCustomerGroupsTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'integrations.easybill.customer-groups.GET';
    }

    public function getDescription(): string
    {
        return 'GET /customer-groups — Kundengruppen listen.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->listCustomerGroups($context->user, $arguments['query'] ?? []);

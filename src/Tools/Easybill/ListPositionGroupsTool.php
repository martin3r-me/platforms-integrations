...
class ListPositionGroupsTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.easybill.position-groups.GET';
    }

    public function getDescription(): string
    {
        return 'GET /position-groups — Artikelgruppen listen.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->listPositionGroups($context->user, $arguments['query'] ?? []);

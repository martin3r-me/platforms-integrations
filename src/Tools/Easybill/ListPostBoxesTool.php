...
class ListPostBoxesTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.easybill.post-boxes.GET';
    }

    public function getDescription(): string
    {
        return 'GET /post-boxes — Brief-Versand-Historie listen.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->listPostBoxes($context->user, $arguments['query'] ?? []);

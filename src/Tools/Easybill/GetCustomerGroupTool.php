...
class GetCustomerGroupTool implements ToolContract, ToolMetadataContract
{
    use GuardsArguments;

    public function getName(): string
    {
        return 'integrations.easybill.customer-group.GET';
    }

    public function getDescription(): string
    {
        return 'GET /customer-groups/{id} — Kundengruppe abrufen.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->getCustomerGroup($context->user, (int) $arguments['group_id']);

...
class GetDocumentPdfTool implements ToolContract, ToolMetadataContract
{
    use GuardsArguments;

    public function getName(): string
    {
        return 'integrations.easybill.document.pdf';
    }

    public function getDescription(): string
    {
        return 'GET /documents/{id}/pdf — Beleg als PDF (base64).';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->getDocumentPdf($context->user, (int) $arguments['document_id']);

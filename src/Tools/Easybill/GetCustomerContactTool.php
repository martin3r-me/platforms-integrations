...
class GetCustomerContactTool implements ToolContract, ToolMetadataContract
{
    use GuardsArguments;

    public function getName(): string
    {
        return 'integrations.easybill.customer.contact.GET';
    }

    public function getDescription(): string
    {
        return 'GET /customers/{customerId}/contacts/{id} — Einzelnen Kontakt abrufen.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->getCustomerContact($context->user, (int) $arguments['customer_id'], (int) $arguments['contact_id']);

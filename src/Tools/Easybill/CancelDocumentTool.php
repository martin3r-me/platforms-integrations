...
class CancelDocumentTool implements ToolContract, ToolMetadataContract
{
    use GuardsArguments;

    public function getName(): string
    {
        return 'integrations.easybill.document.cancel';
    }

    public function getDescription(): string
    {
        return 'POST /documents/{id}/cancel — Beleg stornieren (erzeugt Storno-Beleg).';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->cancelDocument($context->user, (int) $arguments['document_id']);

...
class CreateProjectTool implements ToolContract, ToolMetadataContract
{
    use GuardsArguments;

    public function getName(): string
    {
        return 'integrations.easybill.project.POST';
    }

    public function getDescription(): string
    {
        return 'POST /projects — Projekt anlegen.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->createProject($context->user, $arguments['data']);

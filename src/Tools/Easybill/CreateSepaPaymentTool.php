...
class CreateSepaPaymentTool implements ToolContract, ToolMetadataContract
{
    use GuardsArguments;

    public function getName(): string
    {
        return 'integrations.easybill.sepa-payment.POST';
    }

    public function getDescription(): string
    {
        return 'POST /sepa-payments — SEPA-Zahlung anlegen.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->createSepaPayment($context->user, $arguments['data']);

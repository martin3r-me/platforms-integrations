...
class ListSepaPaymentsTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.easybill.sepa-payments.GET';
    }

    public function getDescription(): string
    {
        return 'GET /sepa-payments — SEPA-Zahlungen listen.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->listSepaPayments($context->user, $arguments['query'] ?? []);

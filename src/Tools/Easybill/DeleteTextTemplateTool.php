...
class DeleteTextTemplateTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.easybill.text-template.DELETE';
    }

    public function getDescription(): string
    {
        return 'DELETE /text-templates/{id} — Text-Vorlage löschen.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->deleteTextTemplate($context->user, (int) $arguments['template_id']);

...
class ListPositionGroupDiscountsTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.easybill.discounts.position-group.GET';
    }

    public function getDescription(): string
    {
        return 'GET /discounts/position-group — Gruppen-Rabatte listen.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->listPositionGroupDiscounts($context->user, $arguments['query'] ?? []);

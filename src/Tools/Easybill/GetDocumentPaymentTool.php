...
class GetDocumentPaymentTool implements ToolContract, ToolMetadataContract
{
    use GuardsArguments;

    public function getName(): string
    {
        return 'integrations.easybill.document-payment.GET';
    }

    public function getDescription(): string
    {
        return 'GET /document-payments/{id} — Einen Zahlungseingang abrufen.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->getDocumentPayment($context->user, (int) $arguments['payment_id']);

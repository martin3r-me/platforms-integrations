...
class ListWebhooksTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.easybill.webhooks.GET';
    }

    public function getDescription(): string
    {
        return 'GET /webhooks — Webhooks listen.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->listWebhooks($context->user, $arguments['query'] ?? []);

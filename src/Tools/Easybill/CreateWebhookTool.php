...
class CreateWebhookTool implements ToolContract, ToolMetadataContract
{
    use GuardsArguments;

    public function getName(): string
    {
        return 'integrations.easybill.webhook.POST';
    }

    public function getDescription(): string
    {
        return 'POST /webhooks — Webhook registrieren.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->createWebhook($context->user, $arguments['data']);

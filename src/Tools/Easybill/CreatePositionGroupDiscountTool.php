...
class CreatePositionGroupDiscountTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.easybill.discount.position-group.POST';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->createPositionGroupDiscount($context->user, $arguments['data']);

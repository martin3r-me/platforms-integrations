...
class ListLoginsTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.easybill.logins.GET';
    }

    public function getDescription(): string
    {
        return 'GET /logins — Login-Konten listen.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->listLogins($context->user, $arguments['query'] ?? []);

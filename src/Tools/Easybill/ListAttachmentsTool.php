...
class ListAttachmentsTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.easybill.attachments.GET';
    }

    public function getDescription(): string
    {
        return 'GET /attachments — Anhänge listen.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->listAttachments($context->user, $arguments['query'] ?? []);

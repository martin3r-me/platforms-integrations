...
class ListSerialNumbersTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.easybill.serial-numbers.GET';
    }

    public function getDescription(): string
    {
        return 'GET /serial-numbers — Seriennummern listen.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->listSerialNumbers($context->user, $arguments['query'] ?? []);

...
class ListDocumentPaymentsTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.easybill.document-payments.GET';
    }

    public function getDescription(): string
    {
        return 'GET /document-payments — Zahlungseingänge listen.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->listDocumentPayments($context->user, $arguments['query'] ?? []);

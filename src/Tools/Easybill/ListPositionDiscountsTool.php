...
class ListPositionDiscountsTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.easybill.discounts.position.GET';
    }

    public function getDescription(): string
    {
        return 'GET /discounts/position — Positions-Rabatte listen.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->listPositionDiscounts($context->user, $arguments['query'] ?? []);

...
class CreateOfferDraftTool implements ToolContract, ToolMetadataContract
{
    use BuildsInvoiceDraftPayload;

    public function getName(): string
    {
        return 'integrations.buchhaltungsbutler.invoices.draft.offer';
    }

    public function getDescription(): string
    {
        return 'POST /invoices/create/draft (type=offer) — Erstellt einen ANGEBOTS-Entwurf in BuchhaltungsButler. Der Entwurf landet unter "Rechnungsstellung → Entwürfe" und kann dort manuell finalisiert werden.';
    }

    public function getSchema(): array
    {
        return $this->invoiceDraftSchema('Angebot');
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result  = $service->createInvoiceDraft($context->user, 'offer', $body);
    ...
    public function getMetadata(): array
    {
        return [
            'category' => 'action',
            'tags' => ['buchhaltungsbutler', 'offers', 'quotations', 'draft', 'create'],
            'read_only' => false,
            'requires_auth' => true,
            'risk_level' => 'write',

...
class CreateInvoiceDraftTool implements ToolContract, ToolMetadataContract
{
    use BuildsInvoiceDraftPayload;

    public function getName(): string
    {
        return 'integrations.buchhaltungsbutler.invoices.draft.invoice';
    }

    public function getDescription(): string
    {
        return 'POST /invoices/create/draft (type=invoice) — Erstellt einen RECHNUNGS-Entwurf in BuchhaltungsButler. Der Entwurf landet unter "Rechnungsstellung → Entwürfe" und kann dort manuell finalisiert werden.';
    }

    public function getSchema(): array
    {
        return $this->invoiceDraftSchema('Rechnung');
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result  = $service->createInvoiceDraft($context->user, 'invoice', $body);
    ...
    public function getMetadata(): array
    {
        return [
            'category' => 'action',
            'tags' => ['buchhaltungsbutler', 'invoices', 'draft', 'create'],
            'read_only' => false,
            'requires_auth' => true,
            'risk_level' => 'write',

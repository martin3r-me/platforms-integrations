...
class ListSuppliersTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'integrations.moss.suppliers.GET';
    }

    public function getDescription(): string
    {
        return 'GET /v1/suppliers - Listet Moss Suppliers (Lieferanten) auf.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $service->getSuppliers($context->user, $filters);
    ...
    public function getMetadata(): array
    {
        return [
            'category' => 'query',
            'tags' => ['moss', 'spend-management', 'suppliers', 'list'],
            'read_only' => true,
            'requires_auth' => true,
            'risk_level' => 'safe',
        ];

...
class ListPaymentTermsTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.moss.payment_terms.GET';
    }

    public function getDescription(): string
    {
        return 'GET /v1/payment-terms - Listet Moss Zahlungsbedingungen auf.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $service->getPaymentTerms($context->user, $filters);
    ...
    public function getMetadata(): array
    {
        return [
            'category' => 'query',
            'tags' => ['moss', 'spend-management', 'payment-terms', 'list'],
            'read_only' => true,
            'requires_auth' => true,
            'risk_level' => 'safe',
        ];

...
/**
 * DedeFleet POST /Employee/WorkTimeStop — Stops work time tracking for an employee.
 * Auto-generiert aus der v2-Swagger-Spec; delegiert an DedefleetApiService::call().
 */
class EmployeeWorkTimeStopTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.dedefleet.employee.work-time-stop.POST';
    }

    public function getDescription(): string
    {
        return 'Stops work time tracking for an employee.
...
Vollständige Feld-/Response-Details: https://ortung.dedefleet.de/swagger (Spec /swagger/data/api/2).';
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->call($context->user, 'POST', '/Employee/WorkTimeStop', $payload);

...
/**
 * Tourenplanung Step 5 — POST /Order/Unassign: löst einen Auftrag aus seiner zugewiesenen Tour (Auftrag bleibt bestehen, wird nur entkoppelt).
 */
class UnassignOrderTool implements ToolContract, ToolMetadataContract
{
    use GuardsArguments;

    public function getName(): string
    {
        return 'integrations.dedefleet.order.unassign.POST';
    }

    public function getDescription(): string
    {
        return 'Tourenplanung Step 5 — POST /Order/Unassign: löst einen Auftrag aus seiner zugewiesenen Tour (Auftrag bleibt bestehen, wird nur entkoppelt).';
    }
    ...
    public function getSchema(): array
    {
        return [
            'type' => 'object',
            'properties' => [
                'orderGuid' => ['type' => 'string', 'description' => 'GUID des zu lösenden Auftrags.'],
                'connection_id' => [
                    'type' => 'integer',
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->unassignOrder($context->user, $payload);

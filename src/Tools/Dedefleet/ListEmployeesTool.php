...
/**
 * GET /Employee/List — Mitarbeiter/Fahrer (DedeFleet, read-only).
 */
class ListEmployeesTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.dedefleet.employees.GET';
    }

    public function getDescription(): string
    {
        return 'GET /Employee/List — Listet Mitarbeiter/Fahrer aus DedeFleet. Optionale Filter/Query via `params`.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->listEmployees($context->user, $params);

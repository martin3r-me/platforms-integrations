...
/**
 * DedeFleet POST /VehicleProfile/Update — Updates an existing vehicle profile.
 * Auto-generiert aus der v2-Swagger-Spec; delegiert an DedefleetApiService::call().
 */
class VehicleProfileUpdateTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.dedefleet.vehicle-profile.update.POST';
    }

    public function getDescription(): string
    {
        return 'Updates an existing vehicle profile.
...
Vollständige Feld-/Response-Details: https://ortung.dedefleet.de/swagger (Spec /swagger/data/api/2).';
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->call($context->user, 'POST', '/VehicleProfile/Update', $payload);

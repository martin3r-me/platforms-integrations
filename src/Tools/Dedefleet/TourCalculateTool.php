...
/**
 * DedeFleet POST /Tour/Calculate — Calculates tour metrics without persisting a tour.
 * Auto-generiert aus der v2-Swagger-Spec; delegiert an DedefleetApiService::call().
 */
class TourCalculateTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.dedefleet.tour.calculate.POST';
    }

    public function getDescription(): string
    {
        return 'Calculates tour metrics without persisting a tour.

REQUEST-Felder (`data`):
- tourGuid: string:uuid — GUID of the tour to calculate.
...
Vollständige Feld-/Response-Details: https://ortung.dedefleet.de/swagger (Spec /swagger/data/api/2).';
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->call($context->user, 'POST', '/Tour/Calculate', $payload);

...
/**
 * DedeFleet GET /Customer/DeleteAll — Deletes all customers of the current client.
 * Auto-generiert aus der v2-Swagger-Spec; delegiert an DedefleetApiService::call().
 */
class CustomerDeleteAllTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.dedefleet.customer.delete-all.GET';
    }

    public function getDescription(): string
    {
        return 'Deletes all customers of the current client.
...
Vollständige Feld-/Response-Details: https://ortung.dedefleet.de/swagger (Spec /swagger/data/api/2).';
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->call($context->user, 'GET', '/Customer/DeleteAll', $payload);

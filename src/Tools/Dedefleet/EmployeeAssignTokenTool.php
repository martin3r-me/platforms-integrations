...
/**
 * DedeFleet POST /Employee/AssignToken — Assigns a token to an employee.
 * Auto-generiert aus der v2-Swagger-Spec; delegiert an DedefleetApiService::call().
 */
class EmployeeAssignTokenTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.dedefleet.employee.assign-token.POST';
    }

    public function getDescription(): string
    {
        return 'Assigns a token to an employee.

REQUEST-Felder (`data`):
- key: string — Reference key to the employee.
- keyType: integer:int32 — Valid values are:
- token: string — Token to identify employee in DriverApp
...
Vollständige Feld-/Response-Details: https://ortung.dedefleet.de/swagger (Spec /swagger/data/api/2).';
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->call($context->user, 'POST', '/Employee/AssignToken', $payload);

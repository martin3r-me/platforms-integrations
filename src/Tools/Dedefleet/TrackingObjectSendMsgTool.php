...
/**
 * DedeFleet POST /TrackingObject/SendMsg — Sends a free-text message to a tracking object.
 * Auto-generiert aus der v2-Swagger-Spec; delegiert an DedefleetApiService::call().
 */
class TrackingObjectSendMsgTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.dedefleet.tracking-object.send-msg.POST';
    }

    public function getDescription(): string
    {
        return 'Sends a free-text message to a tracking object.
...
Vollständige Feld-/Response-Details: https://ortung.dedefleet.de/swagger (Spec /swagger/data/api/2).';
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->call($context->user, 'POST', '/TrackingObject/SendMsg', $payload);

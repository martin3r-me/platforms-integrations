...
/**
 * DedeFleet POST /Tour/OptimizeTourDepartureTime — Optimizes the departure time of a tour.
 * Auto-generiert aus der v2-Swagger-Spec; delegiert an DedefleetApiService::call().
 */
class TourOptimizeTourDepartureTimeTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.dedefleet.tour.optimize-tour-departure-time.POST';
    }

    public function getDescription(): string
    {
        return 'Optimizes the departure time of a tour.

REQUEST-Felder (`data`):
- tourGuid: string:uuid — GUID of the tour to optimize.
...
Vollständige Feld-/Response-Details: https://ortung.dedefleet.de/swagger (Spec /swagger/data/api/2).';
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->call($context->user, 'POST', '/Tour/OptimizeTourDepartureTime', $payload);

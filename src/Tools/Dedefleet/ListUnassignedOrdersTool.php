...
/**
 * GET /Order/ListUnassigned — nicht zugewiesene Auftraege (DedeFleet, read-only).
 */
class ListUnassignedOrdersTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.dedefleet.orders-unassigned.GET';
    }

    public function getDescription(): string
    {
        return 'GET /Order/ListUnassigned — Listet nicht zugewiesene Auftraege aus DedeFleet. Optionale Filter/Query via `params`.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->listUnassignedOrders($context->user, $params);

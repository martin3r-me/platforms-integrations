 ...
 */
class ItemGetStatusTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.dedefleet.item.get-status.POST';
    }

    public function getDescription(): string
    {
        return 'Returns the current status of a specific item.

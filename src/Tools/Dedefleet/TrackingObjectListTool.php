...
/**
 * DedeFleet GET /TrackingObject/List — Returns all tracking objects of the current client.
 * Auto-generiert aus der v2-Swagger-Spec; delegiert an DedefleetApiService::call().
 */
class TrackingObjectListTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.dedefleet.tracking-object.list.GET';
    }

    public function getDescription(): string
    {
        return 'Returns all tracking objects of the current client.
...
Vollständige Feld-/Response-Details: https://ortung.dedefleet.de/swagger (Spec /swagger/data/api/2).';
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->call($context->user, 'GET', '/TrackingObject/List', $payload);

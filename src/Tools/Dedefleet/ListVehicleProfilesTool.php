...
/**
 * GET /VehicleProfile/List — Fahrzeugprofile (DedeFleet, read-only).
 */
class ListVehicleProfilesTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.dedefleet.vehicle-profiles.GET';
    }

    public function getDescription(): string
    {
        return 'GET /VehicleProfile/List — Listet Fahrzeugprofile aus DedeFleet. Optionale Filter/Query via `params`.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->listVehicleProfiles($context->user, $params);
    ...
    public function getMetadata(): array
    {
        return [
            'category' => 'query',
            'tags' => ['dedefleet', 'vehicle-profiles', 'list'],
            'read_only' => true,
            'requires_auth' => true,
            'risk_level' => 'safe',
        ];

...
/**
 * Tourenplanung Step 3 — POST /Order/AssignBulk: weist MEHRERE Aufträge in einem Request derselben Tour zu.
 */
class AssignOrdersBulkTool implements ToolContract, ToolMetadataContract
{
    use GuardsArguments;

    public function getName(): string
    {
        return 'integrations.dedefleet.order.assign-bulk.POST';
    }

    public function getDescription(): string
    {
        return 'Tourenplanung Step 3 — POST /Order/AssignBulk: weist MEHRERE Aufträge in einem Request derselben Tour zu.';
    }
    ...
    public function getSchema(): array
    {
        return [
            'type' => 'object',
            'properties' => [
                'tourGuid' => ['type' => 'string', 'description' => 'GUID der Ziel-Tour.'],
                'orderGuids' => ['type' => 'array', 'description' => 'Liste der Auftrags-GUIDs, die der Tour zugewiesen werden.', 'items' => ['string']],
                'connection_id' => [
                    'type' => 'integer',
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->assignOrdersBulk($context->user, $payload);

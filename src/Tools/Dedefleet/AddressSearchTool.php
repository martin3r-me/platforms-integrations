...
/**
 * DedeFleet POST /Address/Search — Searches for addresses matching the supplied search criteria.
 * Auto-generiert aus der v2-Swagger-Spec; delegiert an DedefleetApiService::call().
 */
class AddressSearchTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.dedefleet.address.search.POST';
    }

    public function getDescription(): string
    {
        return 'Searches for addresses matching the supplied search criteria.
...
Vollständige Feld-/Response-Details: https://ortung.dedefleet.de/swagger (Spec /swagger/data/api/2).';
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->call($context->user, 'POST', '/Address/Search', $payload);

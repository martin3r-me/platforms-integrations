...
/**
 * DedeFleet GET /TrailerObject/ListCurrentData — Returns the latest available live data for all trailers.
 * Auto-generiert aus der v2-Swagger-Spec; delegiert an DedefleetApiService::call().
 */
class TrailerObjectListCurrentDataTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.dedefleet.trailer-object.list-current-data.GET';
    }

    public function getDescription(): string
    {
        return 'Returns the latest available live data for all trailers.
...
Vollständige Feld-/Response-Details: https://ortung.dedefleet.de/swagger (Spec /swagger/data/api/2).';
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->call($context->user, 'GET', '/TrailerObject/ListCurrentData', $payload);

...
/**
 * DedeFleet POST /Order/Get — Returns the full details of a single order.
 * Auto-generiert aus der v2-Swagger-Spec; delegiert an DedefleetApiService::call().
 */
class OrderGetTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.dedefleet.order.get.POST';
    }

    public function getDescription(): string
    {
        return 'Returns the full details of a single order.

REQUEST-Felder (`data`):
- orderGuid: string — GUID of the order to retrieve.
...
Vollständige Feld-/Response-Details: https://ortung.dedefleet.de/swagger (Spec /swagger/data/api/2).';
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->call($context->user, 'POST', '/Order/Get', $payload);

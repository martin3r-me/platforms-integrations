...
/**
 * DedeFleet POST /Customer/DeleteDocument — Removes a previously assigned document from a customer.
 * Auto-generiert aus der v2-Swagger-Spec; delegiert an DedefleetApiService::call().
 */
class CustomerDeleteDocumentTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.dedefleet.customer.delete-document.POST';
    }

    public function getDescription(): string
    {
        return 'Removes a previously assigned document from a customer.

REQUEST-Felder (`data`):
- customerNumber: string — The customer number.
- name: string — File name of the document to remove.
...
Vollständige Feld-/Response-Details: https://ortung.dedefleet.de/swagger (Spec /swagger/data/api/2).';
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->call($context->user, 'POST', '/Customer/DeleteDocument', $payload);

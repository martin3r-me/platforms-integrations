...
/**
 * DedeFleet POST /Tour/Get — Returns the full details of a single tour.
 * Auto-generiert aus der v2-Swagger-Spec; delegiert an DedefleetApiService::call().
 */
class TourGetTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.dedefleet.tour.get.POST';
    }

    public function getDescription(): string
    {
        return 'Returns the full details of a single tour.

REQUEST-Felder (`data`):
- tourGuid: string:uuid — GUID of the tour to retrieve.
...
Vollständige Feld-/Response-Details: https://ortung.dedefleet.de/swagger (Spec /swagger/data/api/2).';
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->call($context->user, 'POST', '/Tour/Get', $payload);

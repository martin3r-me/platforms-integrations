...
/**
 * DedeFleet POST /Item/ListStatus — Returns item status changes within a given time range.
 * Auto-generiert aus der v2-Swagger-Spec; delegiert an DedefleetApiService::call().
 */
class ItemListStatusTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.dedefleet.item.list-status.POST';
    }

    public function getDescription(): string
    {
        return 'Returns item status changes within a given time range.
...
Vollständige Feld-/Response-Details: https://ortung.dedefleet.de/swagger (Spec /swagger/data/api/2).';
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->call($context->user, 'POST', '/Item/ListStatus', $payload);

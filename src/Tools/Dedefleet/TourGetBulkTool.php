...
/**
 * DedeFleet POST /Tour/GetBulk — Basically the same as "Tour/Get" but for bulk operations
 * Auto-generiert aus der v2-Swagger-Spec; delegiert an DedefleetApiService::call().
 */
class TourGetBulkTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.dedefleet.tour.get-bulk.POST';
    }

    public function getDescription(): string
    {
        return 'Basically the same as "Tour/Get" but for bulk operations

REQUEST-Felder (`data`):
- tourGuids: array<string> — GUIDs of the tours to retrieve.
...
Vollständige Feld-/Response-Details: https://ortung.dedefleet.de/swagger (Spec /swagger/data/api/2).';
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->call($context->user, 'POST', '/Tour/GetBulk', $payload);

...
/**
 * DedeFleet POST /Archive/Import — Imports archived data from the supplied file payload.
 * Auto-generiert aus der v2-Swagger-Spec; delegiert an DedefleetApiService::call().
 */
class ArchiveImportTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.dedefleet.archive.import.POST';
    }

    public function getDescription(): string
    {
        return 'Imports archived data from the supplied file payload.

REQUEST-Felder (`data`):
- notificationReceiver: string — Username of the person who should receive the import result.
- filename: string — Original Filename
- content: string:byte — Base64 encoded binary file.
...
Vollständige Feld-/Response-Details: https://ortung.dedefleet.de/swagger (Spec /swagger/data/api/2).';
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->call($context->user, 'POST', '/Archive/Import', $payload);

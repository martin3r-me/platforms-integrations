...
/**
 * DedeFleet POST /Location/Delete — Deletes a location.
 * Auto-generiert aus der v2-Swagger-Spec; delegiert an DedefleetApiService::call().
 */
class LocationDeleteTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.dedefleet.location.delete.POST';
    }

    public function getDescription(): string
    {
        return 'Deletes a location.

REQUEST-Felder (`data`):
- locationNumber: string — The locationNumber of the location you created before.
...
Vollständige Feld-/Response-Details: https://ortung.dedefleet.de/swagger (Spec /swagger/data/api/2).';
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->call($context->user, 'POST', '/Location/Delete', $payload);

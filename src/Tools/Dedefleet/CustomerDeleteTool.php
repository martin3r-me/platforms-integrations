...
/**
 * DedeFleet POST /Customer/Delete — Deletes a single customer identified by the request payload.
 * Auto-generiert aus der v2-Swagger-Spec; delegiert an DedefleetApiService::call().
 */
class CustomerDeleteTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.dedefleet.customer.delete.POST';
    }

    public function getDescription(): string
    {
        return 'Deletes a single customer identified by the request payload.

REQUEST-Felder (`data`):
- customerNumber: string — Customer number of the customer to delete.
...
Vollständige Feld-/Response-Details: https://ortung.dedefleet.de/swagger (Spec /swagger/data/api/2).';
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->call($context->user, 'POST', '/Customer/Delete', $payload);

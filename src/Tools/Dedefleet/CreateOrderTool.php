...
class CreateOrderTool implements ToolContract, ToolMetadataContract
{
    ...
    public function getDescription(): string
    {
        ...
        - Zeit/Menge: plannedDeliveryDate ("DD.MM.YYYY HH:mm"), workTime (Minuten), weight (kg), priority (1–9, 1=höchste), fixed (bool)
        ...
        - Direkt-Zuweisung: tourGuid (GUID einer zuvor erstellten Tour), startDateTime ("DD.MM.YYYY HH:MM:SS", nur mit tourGuid; chronologisch)
            ...
            'properties' => [
                'data' => [
                    ...
                    'description' => 'Auftrags-Daten. Mind. type + location. Beispiel: '
                        ...
                        . '"plannedDeliveryDate":"18.07.2026 09:00","weight":120,"workTime":10}. '

...
/**
 * DedeFleet POST /Event/Update — Updates an existing event.
...
class EventUpdateTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'integrations.dedefleet.event.update.POST';
    }

    public function getDescription(): string
    {
        return 'Updates an existing event.
...
Vollständige Feld-/Response-Details: https://ortung.dedefleet.de/swagger (Spec /swagger/data/api/2).';
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $svc->call($context->user, 'POST', '/Event/Update', $payload);

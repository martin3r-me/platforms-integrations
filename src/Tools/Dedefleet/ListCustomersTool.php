...
/**
 * GET /Customer/List — Kunden (DedeFleet, read-only).
 */
class ListCustomersTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.dedefleet.customers.GET';
    }

    public function getDescription(): string
    {
        return 'GET /Customer/List — Listet Kunden aus DedeFleet. Optionale Filter/Query via `params`.';
    }

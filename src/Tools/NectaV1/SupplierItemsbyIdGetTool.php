...
/**
 * necta.one API v1 — GET /api/v1/{tenantId}/supplier-items/{id}
 * Lieferantenartikel anhand ID laden
 */
class SupplierItemsbyIdGetTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.necta.v1.supplier-items.by-id.GET';
    }

    public function getDescription(): string
    {
        return 'Lieferantenartikel anhand ID laden
...
Spec: https://docu.necta.one/necta.one-api (spec/necta-one.json).';
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        $path = '/api/v1/{tenantId}/supplier-items/{id}';

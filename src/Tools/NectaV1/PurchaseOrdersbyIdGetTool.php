...
/**
 * necta.one API v1 — GET /api/v1/{tenantId}/purchase-orders/{id}
 * Bestellung via ID laden
 */
class PurchaseOrdersbyIdGetTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'integrations.necta.v1.purchase-orders.by-id.GET';
    }

    public function getDescription(): string
    {
        return 'Bestellung via ID laden
...
';
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        $path = '/api/v1/{tenantId}/purchase-orders/{id}';

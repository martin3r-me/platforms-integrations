...
/**
 * necta.one API v1 — GET /api/v1/{tenantId}/dashboard/by-user
 * Dashboards laden
 */
class DashboardbyUserGetTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'integrations.necta.v1.dashboard.by-user.GET';
    }
...
';
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        $path = '/api/v1/{tenantId}/dashboard/by-user';

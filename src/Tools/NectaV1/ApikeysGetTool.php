...
/**
 * necta.one API v1 — GET /api/v1/apikeys
 * ApiKeys für necta.one Benutzer laden
 */
class ApikeysGetTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.necta.v1.apikeys.GET';
    }

    public function getDescription(): string
    {
        return 'ApiKeys für necta.one Benutzer laden

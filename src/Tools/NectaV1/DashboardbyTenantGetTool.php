...
/**
 * necta.one API v1 — GET /api/v1/{tenantId}/dashboard/by-tenant
 * Dashboards laden
 */
class DashboardbyTenantGetTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'integrations.necta.v1.dashboard.by-tenant.GET';
    }

    public function getDescription(): string
    {
        return 'Dashboards laden
...
';
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        $path = '/api/v1/{tenantId}/dashboard/by-tenant';

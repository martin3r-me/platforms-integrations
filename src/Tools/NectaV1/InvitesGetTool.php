...
/**
 * necta.one API v1 — GET /api/v1/invites
 * Alle necta.one Einladungen laden
 */
class InvitesGetTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'integrations.necta.v1.invites.GET';
    }

    public function getDescription(): string
    {
        return 'Alle necta.one Einladungen laden

...
/**
 * necta.one API v1 — GET /api/v1/{tenantId}/invoices/{id}
 * Eingangsrechnung anhand ID laden
 */
class InvoicesbyIdGetTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'integrations.necta.v1.invoices.by-id.GET';
    }

    public function getDescription(): string
    {
        return 'Eingangsrechnung anhand ID laden
...
';
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        $path = '/api/v1/{tenantId}/invoices/{id}';

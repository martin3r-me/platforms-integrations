...
/**
 * necta.one API v1 — GET /api/v1/{tenantId}/users/permissions
 * Benutzerberechtigungen abrufen
 */
class UserspermissionsGetTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'integrations.necta.v1.users.permissions.GET';
    }

    public function getDescription(): string
    {
        return 'Benutzerberechtigungen abrufen
...
';
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        $path = '/api/v1/{tenantId}/users/permissions';

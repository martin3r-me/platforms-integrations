...
/**
 * necta.one API v1 — GET /api/v1/{tenantId}/necta-modules
 * Necta-Module laden
 */
class NectaModulesGetTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'integrations.necta.v1.necta-modules.GET';
    }

    public function getDescription(): string
    {
        return 'Necta-Module laden
...
';
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        $path = '/api/v1/{tenantId}/necta-modules';

...
/**
 * necta.one API v1 — POST /api/v1/necta-modules/cleanup/run-once
 * Cleanup (manuell) auslösen
 */
class NectaModulescleanuprunOncePostTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.necta.v1.necta-modules.cleanup.run-once.POST';
    }

    public function getDescription(): string
    {
        return 'Cleanup (manuell) auslösen
...
Spec: https://docu.necta.one/necta.one-api (spec/necta-one.json).';
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        $path = '/api/v1/necta-modules/cleanup/run-once';

...
/**
 * necta.one API v1 — GET /api/v1/{tenantId}/necta-modules/{moduleId}
 * Necta-Modul nach ModuleId laden
 */
class NectaModulesbyModuleIdGetTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.necta.v1.necta-modules.by-module-id.GET';
    }

    public function getDescription(): string
    {
        return 'Necta-Modul nach ModuleId laden

...
/**
 * necta.one API v1 — DELETE /api/v1/{tenantId}/necta-modules/sessions/{moduleId}
 * Necta-Modul-Session abbrechen
 */
class NectaModulessessionsbyModuleIdDeleteTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'integrations.necta.v1.necta-modules.sessions.by-module-id.DELETE';
    }

    public function getDescription(): string
    {
        return 'Necta-Modul-Session abbrechen
...
';
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        $path = '/api/v1/{tenantId}/necta-modules/sessions/{moduleId}';

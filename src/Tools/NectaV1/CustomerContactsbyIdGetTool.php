...
/**
 * necta.one API v1 — GET /api/v1/{tenantId}/customer-contacts/{id}
 * Kundenkontakt anhand ID laden
 */
class CustomerContactsbyIdGetTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'integrations.necta.v1.customer-contacts.by-id.GET';
    }

    public function getDescription(): string
    {
        return 'Kundenkontakt anhand ID laden
...
';
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        $path = '/api/v1/{tenantId}/customer-contacts/{id}';
    ...
    public function getMetadata(): array
    {
        return [
            'category' => 'query',
            'tags' => ['necta', 'v1', 'customer-contacts'],
            'read_only' => true,
            'requires_auth' => true,
            'risk_level' => 'safe',
        ];

...
class ListQuotationsTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'GET /quotations - Listet Lexware-Angebote auf. Paginiert (page, size).';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $service->getQuotations($context->user, $arguments['page'] ?? 0, $arguments['size'] ?? 25);

...
class ListInvoicesTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'integrations.lexware.invoices.GET';
    }

    public function getDescription(): string
    {
        return 'GET /invoices - Listet Lexware-Rechnungen auf. Paginiert (page, size).';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $service->getInvoices($context->user, $arguments['page'] ?? 0, $arguments['size'] ?? 25);

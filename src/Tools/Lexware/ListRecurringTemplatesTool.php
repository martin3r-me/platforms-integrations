...
class ListRecurringTemplatesTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'GET /recurring-templates - Listet Lexware-Wiederkehrende Vorlagen auf. Paginiert (page, size).';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $service->getRecurringTemplates($context->user, $arguments['page'] ?? 0, $arguments['size'] ?? 25);
    ...
    public function getMetadata(): array
    {
        return [
            'category' => 'query',
            'tags' => ['lexware', 'recurring_templates', 'list'],
            'read_only' => true,
            'requires_auth' => true,
            'risk_level' => 'safe',
        ];

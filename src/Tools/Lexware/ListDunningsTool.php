...
class ListDunningsTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'GET /dunnings - Listet Lexware-Mahnungen auf. Paginiert (page, size).';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $service->getDunnings($context->user, $arguments['page'] ?? 0, $arguments['size'] ?? 25);

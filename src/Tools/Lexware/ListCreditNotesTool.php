...
class ListCreditNotesTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'GET /credit-notes - Listet Lexware-Gutschriften auf. Paginiert (page, size).';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $service->getCreditNotes($context->user, $arguments['page'] ?? 0, $arguments['size'] ?? 25);
    ...
    public function getMetadata(): array
    {
        return [
            'category' => 'query',
            'tags' => ['lexware', 'credit_notes', 'list'],
            'read_only' => true,
            'requires_auth' => true,
            'risk_level' => 'safe',
        ];

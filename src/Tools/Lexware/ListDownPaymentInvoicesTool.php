...
class ListDownPaymentInvoicesTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.lexware.down_payment_invoices.GET';
    }

    public function getDescription(): string
    {
        return 'GET /down-payment-invoices - Listet Lexware-Anzahlungsrechnungen auf. Paginiert (page, size).';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $service->getDownPaymentInvoices($context->user, $arguments['page'] ?? 0, $arguments['size'] ?? 25);
    ...
    public function getMetadata(): array
    {
        return [
            'category' => 'query',
            'tags' => ['lexware', 'down_payment_invoices', 'list'],
            'read_only' => true,
            'requires_auth' => true,
            'risk_level' => 'safe',
        ];

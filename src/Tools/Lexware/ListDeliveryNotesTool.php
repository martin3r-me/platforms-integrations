...
class ListDeliveryNotesTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.lexware.delivery_notes.GET';
    }

    public function getDescription(): string
    {
        return 'GET /delivery-notes - Listet Lexware-Lieferscheine auf. Paginiert (page, size).';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $service->getDeliveryNotes($context->user, $arguments['page'] ?? 0, $arguments['size'] ?? 25);
    ...
    public function getMetadata(): array
    {
        return [
            'category' => 'query',
            'tags' => ['lexware', 'delivery_notes', 'list'],
            'read_only' => true,
            'requires_auth' => true,
            'risk_level' => 'safe',
        ];

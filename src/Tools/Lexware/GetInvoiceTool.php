...
class GetInvoiceTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'GET /invoices/{id} - Ruft eine einzelne Lexware-Rechnung ab. id (string, UUID) - Rechnungs-ID.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $service->getInvoice($context->user, $arguments['id']);

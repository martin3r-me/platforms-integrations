...
class ListPaymentsTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'GET /payments - Listet Lexware-Zahlungen auf. Paginiert (page, size).';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $service->getPayments($context->user, $arguments['page'] ?? 0, $arguments['size'] ?? 25);

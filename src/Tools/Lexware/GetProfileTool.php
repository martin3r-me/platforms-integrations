...
class GetProfileTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'GET /profile - Ruft das Lexware-Profil des verbundenen Accounts ab. Enthält Firmenname, Adresse, Steuerdaten etc.';
    }

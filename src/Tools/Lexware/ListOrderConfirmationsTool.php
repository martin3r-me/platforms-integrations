...
class ListOrderConfirmationsTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.lexware.order_confirmations.GET';
    }

    public function getDescription(): string
    {
        return 'GET /order-confirmations - Listet Lexware-Auftragsbestätigungen auf. Paginiert (page, size).';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $service->getOrderConfirmations($context->user, $arguments['page'] ?? 0, $arguments['size'] ?? 25);
    ...
    public function getMetadata(): array
    {
        return [
            'category' => 'query',
            'tags' => ['lexware', 'order_confirmations', 'list'],
            'read_only' => true,
            'requires_auth' => true,
            'risk_level' => 'safe',
        ];

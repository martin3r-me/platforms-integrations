...
/**
 * Komfort-Tool: GET /rawapi/customers — Kunden (paginiert, read-only).
 * Entspricht integrations.necta.list.GET mit resource="customers".
 */
class ListCustomersTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return "integrations.necta.customers.GET";
    }

    public function getDescription(): string
    {
        return "GET /rawapi/customers — Listet Kunden aus necta.one (paginiert, read-only).";
    }
    ...
    public function getSchema(): array
    {
        return [
            ...
            "properties" => [
                ...
                "filters" => [
                    "type" => "object",
                    "description" => "Optionale Query-Filter (siehe integrations.necta.resources.GET, resource=\"customers\"). "
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $args = NectaListArguments::normalize("customers", $arguments);

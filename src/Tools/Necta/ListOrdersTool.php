...
/**
 * Komfort-Tool: GET /rawapi/orders — Bestellungen (paginiert, read-only).
 * Entspricht integrations.necta.list.GET mit resource="orders".
 */
class ListOrdersTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return "integrations.necta.orders.GET";
    }

    public function getDescription(): string
    {
        return "GET /rawapi/orders — Listet Bestellungen aus necta.one (paginiert, read-only).";
    }
    ...
    public function getSchema(): array
    {
        return [
            ...
            "properties" => [
                ...
                "filters" => [
                    "type" => "object",
                    "description" => "Optionale Query-Filter (siehe integrations.necta.resources.GET, resource=\"orders\"). "
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $args = NectaListArguments::normalize("orders", $arguments);

...
/**
 * Komfort-Tool: GET /rawapi/suppliers — Lieferanten (paginiert, read-only).
 * Entspricht integrations.necta.list.GET mit resource="suppliers".
 */
class ListSuppliersTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return "integrations.necta.suppliers.GET";
    }

    public function getDescription(): string
    {
        return "GET /rawapi/suppliers — Listet Lieferanten aus necta.one (paginiert, read-only).";
    }
    ...
    public function getSchema(): array
    {
        return [
            ...
            "properties" => [
                ...
                "filters" => [
                    "type" => "object",
                    "description" => "Optionale Query-Filter (siehe integrations.necta.resources.GET, resource=\"suppliers\"). "
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $args = NectaListArguments::normalize("suppliers", $arguments);

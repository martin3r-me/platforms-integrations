...
class GetReplyTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.canva.comments.reply.GET';
    }

    public function getDescription(): string
    {
        return 'Ruft eine einzelne Kommentar-Antwort ab.';
    }
    ...
    public function getSchema(): array
    {
        return [
            ...
            'properties' => [
                ...
                'reply_id' => ['type' => 'string', 'description' => 'ID der Antwort.'],
            ],
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        if (empty($arguments['reply_id'])) {
            return ToolResult::error('VALIDATION_ERROR', 'Reply-ID ist erforderlich.');
        }

        try {
            $service = app(CanvaApiService::class)->forConnection($arguments['connection_id'] ?? null);
            $result = $service->getReply($context->user, $arguments['thread_id'], $arguments['reply_id']);

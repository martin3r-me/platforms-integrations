...
/**
 * LLM-Tool: Canva Capabilities abrufen
 *
 * Ruft die Capabilities/Berechtigungen der Canva Connect Integration ab.
 */
class GetCapabilitiesTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.canva.users.capabilities.GET';
    }

    public function getDescription(): string
    {
        return 'Ruft die Capabilities/Berechtigungen der Canva Connect Integration ab.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $service->getCapabilities($context->user);

...
class GetCommentThreadTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.canva.comments.thread.GET';
    }

    public function getDescription(): string
    {
        return 'Ruft einen Kommentar-Thread ab.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $service->getCommentThread($context->user, $arguments['thread_id']);

...
class GetBrandTemplateTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.canva.brand_template.GET';
    }

    public function getDescription(): string
    {
        return 'Ruft ein einzelnes Brand Template ab.';
    }
    ...
    public function getSchema(): array
    {
        return [
            ...
            'properties' => [
                ...
                'brand_template_id' => ['type' => 'string', 'description' => 'ID des Brand Templates.'],
            ],
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $service->getBrandTemplate($context->user, $arguments['brand_template_id']);

...
/**
 * LLM-Tool: Canva User-Profil abrufen
 *
 * Ruft das Profil des aktuell authentifizierten Canva-Users ab.
 */
class GetMeTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.canva.users.me.GET';
    }

    public function getDescription(): string
    {
        return 'Ruft das Profil des aktuell authentifizierten Canva-Users ab.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $service->getMe($context->user);

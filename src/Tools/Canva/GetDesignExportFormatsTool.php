...
/**
 * LLM-Tool: Verfuegbare Export-Formate eines Canva-Designs abrufen
 *
 * Ruft die verfuegbaren Export-Formate (z.B. PDF, PNG, JPG) fuer ein bestimmtes Design ab.
 */
class GetDesignExportFormatsTool implements ToolContract, ToolMetadataContract
{
    public function getName(): string
    {
        return 'integrations.canva.design.export_formats.GET';
    }

    public function getDescription(): string
    {
        return 'Ruft verfuegbare Export-Formate fuer ein Canva-Design ab (z.B. PDF, PNG, JPG). Hilfreich vor dem Erstellen eines Exports.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        ...
        try {
            ...
            $result = $service->getDesignExportFormats($context->user, $designId);
    ...
    public function getMetadata(): array
    {
        return [
            'category' => 'query',
            'tags' => ['canva', 'design', 'export', 'formats'],
            'read_only' => true,
            'requires_auth' => true,
            'risk_level' => 'safe',
        ];

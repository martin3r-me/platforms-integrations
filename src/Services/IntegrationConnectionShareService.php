...
class IntegrationConnectionShareService
{
     ...
     */
    public function createShare(User $user, IntegrationConnection $connection, ?int $teamId, ?int $userId): IntegrationConnectionShare
    {
        $this->assertCanManage($user, $connection);
